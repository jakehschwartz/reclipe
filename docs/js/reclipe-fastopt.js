...
$c_Lreclipe_Main$.prototype = new $h_O();
$c_Lreclipe_Main$.prototype.constructor = $c_Lreclipe_Main$;
/** @constructor */
function $h_Lreclipe_Main$() {
  /*<skip>*/
}
$h_Lreclipe_Main$.prototype = $c_Lreclipe_Main$.prototype;
$c_Lreclipe_Main$.prototype.init___ = (function() {
  $n_Lreclipe_Main$ = this;
  $f_s_App__$$init$__V(this);
  var body = new $c_Lreclipe_Main$delayedInit$body().init___Lreclipe_Main$(this);
  this.scala$App$$initCode$1.$$plus$eq__O__scm_ListBuffer(body);
  return this
});
$c_Lreclipe_Main$.prototype.main__AT__V = (function(args) {
  $f_s_App__main__AT__V(this, args)
});
var $d_Lreclipe_Main$ = new $TypeData().initClass({
  Lreclipe_Main$: 0
}, false, "reclipe.Main$", {
  Lreclipe_Main$: 1,
  O: 1,
...
$c_Lreclipe_Main$.prototype.$classData = $d_Lreclipe_Main$;
var $n_Lreclipe_Main$ = (void 0);
function $m_Lreclipe_Main$() {
  if ((!$n_Lreclipe_Main$)) {
    $n_Lreclipe_Main$ = new $c_Lreclipe_Main$().init___()
  };
  return $n_Lreclipe_Main$
}
/** @constructor */
function $c_Lreclipe_Main$delayedInit$body() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null
}
$c_Lreclipe_Main$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_Lreclipe_Main$delayedInit$body.prototype.constructor = $c_Lreclipe_Main$delayedInit$body;
/** @constructor */
function $h_Lreclipe_Main$delayedInit$body() {
  /*<skip>*/
}
$h_Lreclipe_Main$delayedInit$body.prototype = $c_Lreclipe_Main$delayedInit$body.prototype;
$c_Lreclipe_Main$delayedInit$body.prototype.init___Lreclipe_Main$ = (function($$outer) {
  if (($$outer === null)) {
...
$c_Lreclipe_Main$delayedInit$body.prototype.apply__O = (function() {
...
var $d_Lreclipe_Main$delayedInit$body = new $TypeData().initClass({
  Lreclipe_Main$delayedInit$body: 0
}, false, "reclipe.Main$delayedInit$body", {
  Lreclipe_Main$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_Lreclipe_Main$delayedInit$body.prototype.$classData = $d_Lreclipe_Main$delayedInit$body;
...
$m_Lreclipe_Main$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=reclipe-fastopt.js.map
